...
#    3-sigma area
sigma = 3.0
values = np.random.multivariate_normal(params,matrix, 100000) # draw random values using the covariance matrix
#print values
for z in redshift:
    Phi_low = []
    Phi_high = []
...
#    plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/eAird_comparison.'+ext)
plt.show()
