...
fig.subplots_adjust(left=0.14, top=0.98, right=0.95, wspace=0.05, hspace=0.05)
...
for i in [1,2,3,4,5]:
    ...
    plt.errorbar(z,10.**(array(Lx)),label=field_name.next(),markersize = 9.0,marker=mstyles.next(),markeredgecolor=medgecolors.next(),markerfacecolor=mcolors.next(),ecolor=lcolors.next(),ls=' ')
plt.legend(loc=4)
plt.yscale('log',nonposy='clip')
plt.xscale('log',nonposx='clip')
...
plt.draw()
plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/Lx_z.jpg',dpi=300)
plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/Lx_z.eps')
plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/Lx_z.png')
...
#    plt.errorbar(z,10.**(array(Lx)),label=field_name.next(),markersize = 5,marker=mstyles.next(),markeredgecolor=medgecolors_c.next(),markerfacecolor=mcolors_c.next(),ecolor=lcolors_c.next(),ls=' ')
#
