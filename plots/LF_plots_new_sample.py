...
fig.subplots_adjust(left=0.17, top=0.98, right=0.95, wspace=0.05, hspace=0.05)
...
mstyles = itertools.cycle(['s','o','s','o','v',"s",'^'])
...
lcolors_c = itertools.cycle(['red','blue','cyan','green','gray','black'])
mcolors_c = itertools.cycle(['red','blue','gray','cyan','black','white'])
medgecolors_c = itertools.cycle(['black','black','black','black','black','black'])

#lcolors_c = itertools.cycle(['black','black','gray','black','blue','magenta','black'])
#mcolors_c = itertools.cycle(['white','black','gray','white','blue','white','black'])
#medgecolors_c = itertools.cycle(['black','black','gray','black','blue','magenta','black'])
...
data_name='temp_Input_Data.fits'
...
CDFN = fdata[fdata.field('field')==6]
AEGIS = fdata[fdata.field('field')==7]
...
CDFN_S = log10(CDFN.field('Flux'))
AEGIS_S = log10(AEGIS.field('Flux'))
...
CDFN_z = CDFN.field('redshift')
AEGIS_z = AEGIS.field('redshift')
...
MAXI_Rc = MAXI.field('mag')
CDFN_Rc = CDFN.field('mag')
AEGIS_Rc = AEGIS.field('mag')
...
#plt.draw()
#plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/Fx_z.jpg',dpi=300)
#plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/Fx_z.eps')
#plt.show()
#
#
#    For presentations
#plt.figure(1,figsize=(12,12))
#ax = plt.subplot(111)
#s0_c = plt.errorbar(MAXI_z, 10.**MAXI_S, ls = ' ',markersize = 10,color=mcolors_c.next(), marker=mstyles.next(),markeredgecolor=medgecolors_c.next())
...
#s4_c = plt.errorbar(AEGIS_z, 10.**AEGIS_S, ls = ' ',markersize = 10,color=mcolors_c.next(), marker=mstyles.next(),markeredgecolor=medgecolors_c.next())
#s5_c = plt.errorbar(CDFS_z, 10.**CDFS_S, ls = ' ',markersize = 10,color=mcolors_c.next(), marker=mstyles.next(),markeredgecolor=medgecolors_c.next())
#s6_c = plt.errorbar(CDFN_z, 10.**CDFN_S, ls = ' ',markersize = 10,color=mcolors_c.next(), marker=mstyles.next(),markeredgecolor=medgecolors_c.next())
#
#plt.legend([s1_c,s2_c,s3_c,s4_c,s5_c,s6_c],['HBSS','COSMOS','LH','AEGIS','CDFS','CDFN'],scatterpoints=1,loc=3)
#
#ax.set_yscale('log')
#ax.set_xscale('log')
#plt.xlabel(r'$z$')
#plt.ylabel(r'$F_{5-10keV}/erg\cdot s^{-1}\cdot cm^{-2}$')
#plt.xlim([1.5e-2,7])
#plt.ylim([2e-16,2e-12])
#plt.draw()
##plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/Fx_z_c.jpg',dpi=300)
##plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/Fx_z_c.eps')
#plt.show()
##
##### Area Curve
...
####ax2 = plt.subplot(111)
###a1 = plt.plot(10.**HBSS_aFlux, HBSS_aArea, lw=3, ls=lstyles.next(),color=lcolors.next())
###a2 = plt.plot(10.**COSMOS_aFlux, COSMOS_aArea, lw=3,ls=lstyles.next(),color=lcolors.next())
###a3 = plt.plot(10.**LH_aFlux, LH_aArea, lw=3,ls=lstyles.next(),color=lcolors.next())
###a4 = plt.plot(10.**CDFS_aFlux, CDFS_aArea, lw=3,ls=lstyles.next(),color=lcolors.next())
###a5 = plt.plot(10.**MAXI_aFlux, MAXI_aArea, lw=3,ls=lstyles.next(),color=lcolors.next())
###
###plt.legend([a5,a1,a2,a3,a4],['MAXI','HBSS','COSMOS','LH','CDFS'],loc=2)
###
###ax.set_yscale('log')
###ax.set_xscale('log')
###plt.ylabel(r'$\log(area/deg^2)$')
###plt.xlabel(r'$\log(F_{5-10keV}/erg\cdot s^{-1}\cdot cm^{-2})$')
###plt.ylim([1e-2,5e4])
###plt.xlim([1e-16,1e-9])
###plt.draw()
###plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/area_curve.jpg',dpi=300)
###plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/area_curve.eps')
###plt.show()
####
#
plt.figure(2,figsize=(10,10))
ax2 = plt.subplot(111)
a1 = plt.plot(10.**HBSS_aFlux, HBSS_aArea, lw=4, ls=lstyles.next(),color=lcolors_c.next())
a2 = plt.plot(10.**COSMOS_aFlux, COSMOS_aArea, lw=4,ls=lstyles.next(),color=lcolors_c.next())
a3 = plt.plot(10.**LH_aFlux, LH_aArea, lw=4,ls=lstyles.next(),color=lcolors_c.next())
a4 = plt.plot(10.**CDFS_aFlux, CDFS_aArea, lw=4,ls=lstyles.next(),color=lcolors_c.next())
plt.legend([a1,a2,a3,a4],['HBSS','COSMOS','LH','CDFS'],loc=2)
ax2.set_yscale('log')
ax2.set_xscale('log')
plt.ylabel(r'$area/deg^2$')
plt.xlabel(r'$F_{5-10keV}/erg\cdot s^{-1}\cdot cm^{-2}$')
plt.ylim([0,50])
plt.xlim([1e-16,3e-12])
plt.draw()
plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/area_curve_c.jpg',dpi=300)
plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/area_curve_c.eps')
plt.show()
#"""
...
#### Plot L-z
field = itertools.cycle([MAXI_S, HBSS_S,COSMOS_S,LH_S,AEGIS_S,CDFS_S,CDFN_S])
field_z = itertools.cycle([MAXI_z, HBSS_z,COSMOS_z,LH_z,AEGIS_z,CDFS_z,CDFN_z])
field_name = itertools.cycle(['MAXI','HBSS','COSMOS','LH','AEGIS','CDFS','CDFN'])
...
for i in [1,2,3,4,5,6,7]:
    ...
    plt.errorbar(z,10.**(array(Lx)),label=field_name.next(),markersize = 9,marker=mstyles.next(),
                 markeredgecolor=medgecolors_c.next(),markerfacecolor=mcolors_c.next(),ecolor=lcolors_c.next(),ls=' ')
plt.legend(loc=2)
plt.yscale('log',nonposy='clip')
plt.xscale('log',nonposx='clip')
plt.ylim([1e41,8e45])
plt.xlim([0.01,5])
plt.ylabel(r'$L_X /erg\cdot s^{-1}$', fontsize='x-large')
plt.xlabel(r'$z$', fontsize='x-large')
plt.draw()
for ext in ["pdf","svg","jpg","eps"]:
    plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/Lx_z_new_sample.'+ext)
plt.show()
#plt.figure(4,figsize=(12,12))
#ax4 = plt.subplot(111)
...
#    z = field_z.next()
#    z_e = z*0.1
#    Lx, Lx_e = s.get_luminosity(F,F_e,z,z_e)
#    plt.errorbar(z,10.**(array(Lx)),label=field_name.next(),markersize = 5,marker=mstyles.next(),
#                markeredgecolor=medgecolors_c.next(),markerfacecolor=mcolors_c.next(),ecolor=lcolors_c.next(),ls=' ')
#
##from numpy import logspace,linspace,ones
###F = logspace(-11,-13)
##F = list(ones(10)*(1e-13))
##F_err = logspace(1e-3,1e-11,10)
##z = logspace(log10(0.01),log10(5.0),10)
##z_err = logspace(0.015,0.05,10)
##Lx, Lx_err = s.get_luminosity(F, F_err, z, z_err)
##
#F = [1e-7]
#F_err = [1e-10]
#z = [5.0]
#z_err = [0.001]
#L,Lerr = s.get_luminosity(F, F_err, z, z_err)
#print L
##plt.plot(z,10.**(array(Lx)),'bo')
##
##F = list(ones(10)*(1e-11))
##F_err = logspace(1e-3,1e-11,10)
##z = logspace(log10(0.01),log10(5.0),10)
##z_err = logspace(0.015,0.05,10)
##Lx, Lx_err = s.get_luminosity(F, F_err, z, z_err)
##
##plt.plot(z,10.**(array(Lx)),'ro')
#
#"""
...
field_z = itertools.cycle([MAXI_z, HBSS_z,COSMOS_z,LH_z,AEGIS_z,CDFS_z,CDFN_z])
field_name = itertools.cycle(['MAXI','HBSS','COSMOS','LH','AEGIS','CDFS','CDFN'])
field_R = itertools.cycle([MAXI_Rc,HBSS_Rc,COSMOS_Rc,LH_Rc,AEGIS_Rc,CDFS_Rc,CDFN_Rc])
for i in [1,2,3,4,5,6,7]:
    Fx = 10.**field.next()
    z = field_z.next()
    Rc = field_R.next()
#    plt.errorbar(Fx,Rc,label=field_name.next(),markersize = 8.5,marker=mstyles.next(),
#                 markeredgecolor=medgecolors.next(),markerfacecolor=mcolors.next(),ecolor=lcolors.next(),ls=' ')
    plt.errorbar(Fx,Rc,label=field_name.next(),markersize = 10,marker=mstyles.next(),
                 markeredgecolor=medgecolors_c.next(),markerfacecolor=mcolors_c.next(),ecolor=lcolors_c.next(),ls=' ')
...
plt.plot(10**(-3.5-R/2.5),R,color='k',ls='--')
plt.plot(10**(-7.5-R/2.5),R,color='k',ls='--')
...
#plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/fx-fopt.jpg',dpi=300)
#plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/fx-fopt.eps')
#plt.show()
#        
#plt.axhline(y=22.5,color='black',linestyle=':')
#plt.axvline(x=8e-15,color='black',linestyle='--')
...
plt.xlabel(r'$F_X /erg\cdot s^{-1}\cdot cm^{-2}$')
plt.ylabel(r'$Rc\, mag\, (AB)$')
plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/fx-fopt_c.jpg',dpi=300)
plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/fx-fopt_c.eps')
plt.show()