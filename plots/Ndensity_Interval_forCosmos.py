...
# Vmax Points
zbin_min, zbin_max, z_min_Vmax, z_max_Vmax, z_Vmax, Lbin_min, Lbin_max, L_min_Vmax, L_max_Vmax, L_Vmax, N_Vmax, Ndensity_Vmax, Ndensity_err_Vmax = np.loadtxt( path + 'data/Vmax_Ndensity.dat', unpack=True )

# LF grid
redshift = np.linspace(0., 8., 30)
#luminosity = [41., 42., 43., 44., 45., 46.]
luminosity = [43.56, 44.15, 45.1]
# model
models = ['LDDE', 'LADE', 'ILDE', 'PDE', 'PLE']

for model in models:
    out_file = open(path + 'data/Ndensity_interval_forCosmos'+model+'.dat', 'w')
