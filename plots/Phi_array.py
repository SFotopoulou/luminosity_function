...
draws = genfromtxt('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/covariance/Yencho.prob')
...
for z in zbin:
    filename = '/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/covariance/Yencho_Phi_'+str(z)+"_prob.dat"
    ...
    out_interval_name = "/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/covariance/Yencho_"+str(z)+"_99_interval.dat"  
