...
print scaled
print
Yencho_sigma = array(Yencho_e_params)
stds = np.outer(Yencho_sigma, Yencho_sigma)
Yencho_matrix = stds*scaled
print Yencho_matrix
label = 'Yencho'
values = np.random.multivariate_normal(Yencho_params, Yencho_matrix, 10000)
