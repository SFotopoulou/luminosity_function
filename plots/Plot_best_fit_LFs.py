...
#            plt.plot(Lx, Phi,ls='-.',lw=3, color ='k',label=label_d)       
            ...
            plt.plot(Lx, Phi, ls='-',lw=4, label=label_d,color=mod_color)
...
for ext in ['jpg','pdf','eps','png']:
    plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/best_fit_LFs.'+ext)
plt.show()
