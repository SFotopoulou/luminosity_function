...
sys.path.append('/home/Sotiria/Documents/Science/Talks/configuration/xkcd')
import itertools
...
fig.subplots_adjust(left=0.12, bottom=0.11, right=0.98, top=0.97,wspace=0.30, hspace=0.23)
...
#    print len(All.compressed())
    ...
    ax.hist(All, bins=np.linspace(0,4,10),  histtype='step', color= 'black',normed=False,label=fredshift, ls='solid',lw=2.5)
...
#    if i == 4:
    ax.set_xlabel('Redshift', fontsize='medium')
#    ax.xaxis.set_label_coords(0.5, -0.15)
#    if i == 3:
    ax.set_ylabel(r'Number of sources', fontsize='medium')
...
#    plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/5-10data/LH_zHisto.'+ext)
