...
def Phi(Lx,z,L0,g1,g2,p1,a):    
    ...
    zc = 1.9
    La = 44.6
    Normal = random.gauss(-5.297, 0.028)
    return model.Ueda(Lx,z,L0,g1,g2,p1,p2,zc,La,a)*power(10.0, Normal)

## Draw from the luminosity function    
import time
start_time = time.time()
draws = genfromtxt('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/covariance/Ueda.prob')
...
for z in zbin:
    filename = '/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/covariance/Ueda_Phi_'+str(z)+"_prob.dat"
    ...
    out_interval_name = "/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/covariance/Ueda_"+str(z)+"_99_interval.dat"  
