...
for z in zbin:
    filename_in = '/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/covariance/combined_Phi_'+str(z)+"_prob.dat"
    LF = genfromtxt(filename_in)
    
    out_interval_name = "/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/covariance/combined_"+str(z)+"_99_interval.dat"  
