...
fig = plt.figure(figsize=(10.0,6.667))
...
for z,i in zip(redshift, np.arange(len(redshift))):
    PLE = np.log10(m.PLE(Lx,z,43.8, 1.1, 4.5, 3.0, -2.5, 1.8))-6
...
for z,i in zip(redshift, np.arange(len(redshift))):
    PDE = np.log10(m.PDE(Lx,z,43.8, 1.1, 4.5, 6.0, -6.0, 1.8))-6
...
for z,i in zip(redshift, np.arange(len(redshift))):
    ILDE = np.log10(m.ILDE(Lx,z,43.8, 1.1, 4.5, 4, -2.5))-6
...
for z,i in zip(redshift, np.arange(len(redshift))):
    LADE = np.log10(m.LADEc(Lx,z,43.8, 1.1, 4.5, 4, -3.5, 1.8, -0.3))-6
...
for z,i in zip(redshift, np.arange(len(redshift))):
    Fotopoulou = np.log10(m.Fotopoulou(Lx,z,43.8, 1.1, 4.5, 6.5, -2.5, 1.8, 44.8, 0.2))-6
