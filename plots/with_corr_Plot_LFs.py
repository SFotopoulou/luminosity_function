...
#        plt.plot(LF_ll, LF_upper, color='gray', ls='-', lw = 1)
#
#        interval_name = "/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/previous_fits/Ueda/"+str( z  )+"_99_interval.dat"
#        interval = genfromtxt(interval_name)
#        LF_ll = interval[:, 0]
#        LF_low = log10( interval[:, 1] )
#        LF_upper = log10( interval[:, 2] )
...
plt.draw()
#plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/with_correction_comparison_w_errors.jpg')
#plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/with_correction_comparison_w_errors.eps')
plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/meta_LF_with_correction_comparison_w_errors.pdf')
#plt.savefig('/home/sotiria/workspace/Luminosity_Function/src/LF_Plots/with_correction_comparison_w_errors.png')
