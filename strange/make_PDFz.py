...
class Spectrum:
    ...
    def return_PDF(self,field,ID,filename=None):
        ...
        elif field == 'XXL_North_XLF_1_field':
            file = pyfits.open('/home/Sotiria/Dropbox/AGNinCL/input_files/PDFs/XXL_North_XLF_1_field_photoz_PDF.fits')[1].data    
        elif field == 'XXL_South_XLF_1_field':
            file = pyfits.open('/home/Sotiria/Dropbox/AGNinCL/input_files/PDFs/XXL_South_XLF_1_field_photoz_PDF.fits')[1].data                 
        elif field == 'XXL_North_XLF_1_projected':
            file = pyfits.open('/home/Sotiria/Dropbox/AGNinCL/input_files/PDFs/XXL_North_XLF_1_projected_photoz_PDF.fits')[1].data    
        elif field == 'XXL_South_XLF_1_projected':
            file = pyfits.open('/home/Sotiria/Dropbox/AGNinCL/input_files/PDFs/XXL_South_XLF_1_projected_photoz_PDF.fits')[1].data                 
        elif field == 'other':
            try:
                filelist = open(filename, 'r').readlines()
            except IOError:
            ...
            for file in filelist:
                ...
                if fid == ID:
                    if field=='X_CDFS' or field == 'XMM_CDFS' or field=="Chandra_COSMOS":
                        xpdf, ypdf = np.loadtxt(fin, unpack=True)    
                    else:    
